...
// ── desglosaDetalle vive en utils; se importa para uso interno y se re-exporta
// por retrocompatibilidad con cualquier import desde pedidosService ────────────
import { desglosaDetalle } from "../utils/pedidosUtils";
export { desglosaDetalle };
